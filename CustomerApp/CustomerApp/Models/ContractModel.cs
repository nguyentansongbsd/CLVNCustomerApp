...
namespace CustomerApp.Models
{
    public class ContractModel : BaseViewModel
    {
        ...
        public string bsd_unitstatus_format { get => Data.GetStatusCodeById(bsd_unitstatus.ToString())?.Name; }
        ...
        public string bsd_allowchangeunitsspec_format { get { return Data.GetStringByBool(bsd_allowchangeunitsspec); } }
        ...
        public string bsd_followuplist_format { get { return Data.GetStringByBool(bsd_followuplist); } }
        public bool bsd_terminationletter { get; set; } // thư thanh lý
        public string bsd_terminationletter_format { get { return Data.GetStringByBool(bsd_terminationletter); } }
        public bool bsd_specialcontractprintingapproval { get; set; } // duyệt in đặc biệt
        public string bsd_specialcontractprintingapproval_format { get { return Data.GetStringByBool(bsd_specialcontractprintingapproval); } }
        ...
        //    get
        //    {
        //        var type = Data.GetContractTypeById(bsd_contracttypedescription.ToString());
        //        if (type != null)
        //            return type.Label;
        //        else
        //            return "";
        ...
        public string bsd_updatecontractdate_format { get { return Data.GetStringByBool(bsd_updatecontractdate); } }
